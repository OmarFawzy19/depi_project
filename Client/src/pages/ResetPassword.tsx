...
const ResetPassword = () => {
  ...
  const handleReset = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!email) {
      toast({
        title: "Reset failed",
        description: "No reset request session found. Please request OTP again.",
        variant: "destructive",
      });
    ...
    try {
      ...
      toast({
        title: "Reset failed",
        description: getErrorMessage(err, "Something went wrong. Please check your OTP and try again."),
        variant: "destructive",
      });
    } finally {
      setLoading(false);
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl bg-card p-8 shadow-card">
          ...
          <div className="mt-6 flex items-center justify-center">
            <Link to="/forgot-password" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors">
