  ...
  const handleVerify = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!tempUser.email) {
      toast({
        ...
        description: "No pending account details found. Please sign up again.",
        variant: "destructive",
      });
      navigate("/register");
      return;
    ...
    try {
      ...
      toast({
        ...
        description: getErrorMessage(err, "Invalid OTP code. Please try again."),
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-4 font-heading text-2xl font-bold">Enter OTP</h1>
        ...
        <div className="rounded-2xl bg-card p-8 shadow-card">
          ...
          <div className="mt-6 flex items-center justify-center">
            <Link to="/register" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors">
